...
select *from kelimeler where kelime ilike '%ot%' or kelime like '%at%';
...
select *from kelimeler where kelime ~~* '%t' or kelime like '%m'; 
select*from kelimeler where kelime ~* '(.*)[tm]$';
select*from kelimeler where kelime ~* '(.*)t|(.*)m';
...
select*from kelimeler where kelime ~* 'h[a-z,A-Z,0-9]';

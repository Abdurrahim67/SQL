...
--Tablodan alacağınız veriyi inceliyoruz. önce hangisi gelmesii lazımsa onu almanın iki yolu var. 
--fromdan sonra önce o tablo ismini yazıp left kullanacaz. 
--veya joinden sonra o tablo ismini yazdıysak right yazarak o tablonun önce secilmesini sağlarız

...
select*from kisiler ORDER BY adres asc; --ASCANDING (ASC) yazmakta sirali verir

-- kisiler tablosunu adres'e göre tersten sıralayarak sorgulayınız.
select*from kisiler ORDER BY adres desc;--DESCENDIG (DESC) tersten siralama yapacagimiz zaman kullaniriz

--Kisiler maasi büyükten kücüge siralayiniz.
